    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr align="right">
        <td>
			...
			<img style="CURSOR: hand;WIDTH: 126px; HEIGHT: 39px;" onClick="continueBuy()" src="images/Car_icon_02.gif" />
			<img style="WIDTH: 126px; HEIGHT: 39px;" src="images/Car_icon_03.gif" onClick="next()" border="0" style="CURSOR: hand"/>
		</td>
      </tr>
      <tr align="right">
        <td height="20">&nbsp;</td>
