...
<html:form action="/Admin/login.do?method=login">
	<table width="551" height="350" border="0" align="center" cellpadding="0" cellspacing="0" background="../images/login_back.png">
	  <tr>
		<td height="203">&nbsp;</td>
	  </tr>
	  <tr>
		<td><table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			...
			<td width="80">
				<div align="right">				
					<input type="image" src="../images/login_button.png" border="0">
				</div>
			</td>
		  </tr>
		  <tr>
